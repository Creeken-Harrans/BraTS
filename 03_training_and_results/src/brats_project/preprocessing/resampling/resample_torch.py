...
from brats_project.preprocessing.resampling.default_resampling import determine_do_sep_z_and_axis
...
if __name__ == '__main__':
    ...
    img_file = '/media/isensee/raw_data/PROJECT_RAW/Dataset027_ACDC/imagesTr/patient041_frame01_0000.nii.gz'
    seg_file = '/media/isensee/raw_data/PROJECT_RAW/Dataset027_ACDC/labelsTr/patient041_frame01.nii.gz'
    io = SimpleITKIO()
