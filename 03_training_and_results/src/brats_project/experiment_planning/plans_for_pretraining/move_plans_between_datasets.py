...
from brats_project.utilities.file_path_utilities import maybe_convert_to_dataset_name
...
def move_plans_between_datasets(
    ...
    source_folder = join(PROJECT_PREPROCESSED, source_dataset_name)
    ...
    target_raw_data_dir = join(PROJECT_RAW, target_dataset_name)
    ...
    save_json(
        source_plans,
        join(
            PROJECT_PREPROCESSED, target_dataset_name, target_plans_identifier + ".json"
        ),
        sort_keys=False,
    )
