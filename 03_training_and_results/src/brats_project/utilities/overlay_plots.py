...
from brats_project.training.dataloading.nnunet_dataset import infer_dataset_class, nnUNetBaseDataset
from brats_project.utilities.dataset_name_id_conversion import maybe_convert_to_dataset_name
from brats_project.utilities.plans_handling.plans_handler import ConfigurationManager
from brats_project.utilities.utils import get_identifiers_from_splitted_dataset_folder, \
...
def generate_overlays_from_raw(dataset_name_or_id: Union[int, str], output_folder: str,
    ...
    folder = join(PROJECT_RAW, dataset_name)
...
def generate_overlays_from_preprocessed(dataset_name_or_id: Union[int, str], output_folder: str,
                                        ...
                                        overlay_intensity: float = 0.6):
    dataset_name = maybe_convert_to_dataset_name(dataset_name_or_id)
    folder = join(PROJECT_PREPROCESSED, dataset_name)
