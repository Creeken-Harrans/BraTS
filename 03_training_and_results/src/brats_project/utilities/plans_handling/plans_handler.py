...
from brats_project.preprocessing.resampling.utils import recursive_find_resampling_fn_by_name
import brats_project
from batchgenerators.utilities.file_and_folder_operations import load_json, join

from brats_project.imageio.reader_writer_registry import recursive_find_reader_writer_by_name
from brats_project.utilities.find_class_by_name import recursive_find_python_class
from brats_project.utilities.label_handling.label_handling import get_labelmanager_class_from_plans
...
if TYPE_CHECKING:
    ...
    from brats_project.preprocessing.preprocessors.default_preprocessor import DefaultPreprocessor
...
class ConfigurationManager(object):
    ...
    def preprocessor_class(self) -> Type[DefaultPreprocessor]:
        preprocessor_class = recursive_find_python_class(join(brats_project.__path__[0], "preprocessing"),
                                                         self.preprocessor_name,
                                                         current_module="brats_project.preprocessing")
...
if __name__ == '__main__':
    ...
    plans = load_json(join(PROJECT_PREPROCESSED, maybe_convert_to_dataset_name(3), 'nnUNetPlans.json'))
