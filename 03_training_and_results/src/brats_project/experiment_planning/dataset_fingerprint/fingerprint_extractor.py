...
class DatasetFingerprintExtractor(object):
    def __init__(
        ...
        self.input_folder = join(PROJECT_RAW, dataset_name)
    ...
    def run(self, overwrite_existing: bool = False) -> dict:
        ...
        # reliably write in PROJECT_PREPROCESSED and PROJECT_RESULTS, so PROJECT_PREPROCESSED it is
        preprocessed_output_folder = join(PROJECT_PREPROCESSED, self.dataset_name)
