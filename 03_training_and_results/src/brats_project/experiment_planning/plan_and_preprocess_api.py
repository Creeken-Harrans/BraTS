...
from brats_project.experiment_planning.dataset_fingerprint.fingerprint_extractor import (
    DatasetFingerprintExtractor,
)
from brats_project.experiment_planning.experiment_planners.default_experiment_planner import (
    ExperimentPlanner,
)
...
def extract_fingerprints(
    ...
    fingerprint_extractor_class = recursive_find_python_class(
        join(brats_project.__path__[0], "experiment_planning"),
