...
from brats_project.evaluation.evaluate_predictions import region_or_label_to_mask, compute_metrics_on_folder, \
...
from brats_project.utilities.file_path_utilities import folds_tuple_to_string
...
if __name__ == '__main__':
    ...
    labelstr = join(PROJECT_RAW, 'Dataset004_Hippocampus', 'labelsTr')
